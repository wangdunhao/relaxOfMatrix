...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        a.init("C:\\Users\\wangdunhao\\Desktop\\d3\\Louvainjava\\Louvain1\\Louvain\\data\\testdata.txt");
        a.louvain();
        double endTime = System.currentTimeMillis();
        writeOutputJson("F:\\facebook.json", a);  //输出至d3显示
        writeOutputCluster("F:\\cluster.txt",a);  //打印每个节点属于哪个簇
        writeOutputCircle("F:\\circle.txt",a);   //打印每个簇有哪些节点
